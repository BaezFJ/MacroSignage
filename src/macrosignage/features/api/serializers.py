...
def serialize_media(media: MediaAsset) -> dict[str, object]:
    return {
        ...
        "neonTextColor": media.neon_text_color,
        "neonFrameColor": media.neon_frame_color,
        "neonBackgroundColor": media.neon_background_color,
        "neonFontFamily": media.neon_font_family,
        "neonFontSize": media.neon_font_size,
        "neonFrameThickness": media.neon_frame_thickness,
        "vcardName": media.vcard_name,
        "vcardPhone": media.vcard_phone,
        "vcardEmail": media.vcard_email,
        "vcardAddress": media.vcard_address,
        "vcardUrl": media.vcard_url,
        "vcardTopText": media.vcard_top_text,
        "vcardBottomText": media.vcard_bottom_text,
        "notes": media.notes,
...
def serialize_font(font: MediaFont) -> dict[str, object]:
    return {
        ...
        "localStylesheetUrl": media_file_url(font.local_css_path),
        "downloadStatus": font.download_status,
        "downloadError": font.download_error,
        "active": font.active,
