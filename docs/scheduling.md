...
The schedule default duration controls regular image, text, HTML, YouTube, and video slide timing in the player. Slider media uses each slide's own duration.
